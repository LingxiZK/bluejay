...
DEFAULT_PGM_BEEP_STRENGTH EQU 0        ; 0..255 (BLHeli_S is 1..255)
...
DEFAULT_PGM_STARTUP_POWER_MIN EQU 96    ; 0..255 => (1000..1125 Throttle): value * (1000 / 2047) + 1000
DEFAULT_PGM_STARTUP_BEEP EQU 1          ; 0=Short beep,1=Melody

DEFAULT_PGM_STARTUP_POWER_MAX EQU 80    ; 0..255 => (1000..2000 Throttle): Maximum startup power
DEFAULT_PGM_BRAKING_STRENGTH EQU 70    ; 0..255 => 0..100 % Braking
